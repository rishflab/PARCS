/****************************************************************************
** Meta object code from reading C++ file 'tracker.hpp'
**
...
#error "The header file 'tracker.hpp' doesn't include <QObject>."
...
const QMetaObject Tracker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Tracker.data,
      qt_meta_data_Tracker,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
